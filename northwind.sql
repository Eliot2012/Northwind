...
--
-- Name: Northwinduggroups; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."Northwinduggroups" (
...
ALTER TABLE public."Northwinduggroups" OWNER TO postgres;

--
-- Name: Northwinduggroups_GroupID_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."Northwinduggroups_GroupID_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public."Northwinduggroups_GroupID_seq" OWNER TO postgres;

--
-- Name: Northwinduggroups_GroupID_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."Northwinduggroups_GroupID_seq" OWNED BY public."Northwinduggroups"."GroupID";


--
-- Name: Northwindugmembers; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."Northwindugmembers" (
...
ALTER TABLE public."Northwindugmembers" OWNER TO postgres;

--
-- Name: Northwindugrights; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."Northwindugrights" (
...
ALTER TABLE public."Northwindugrights" OWNER TO postgres;
...
ALTER SEQUENCE public.shippers_shipperid_seq OWNER TO postgres;
...
--
-- Name: Northwinduggroups GroupID; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Northwinduggroups" ALTER COLUMN "GroupID" SET DEFAULT nextval('public."Northwinduggroups_GroupID_seq"'::regclass);
...
--
-- Data for Name: Northwinduggroups; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."Northwinduggroups" ("GroupID", "Label", "Provider", "Comment") FROM stdin;
1	users		\N
\.


--
-- Data for Name: Northwindugmembers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."Northwindugmembers" ("UserName", "GroupID", "Provider") FROM stdin;
admin	-1	
user	1	
\.
...
--
-- Data for Name: Northwindugrights; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."Northwindugrights" ("TableName", "GroupID", "AccessMask", "Page") FROM stdin;
<global>	-1	ADESPIM	\N
public.categories	-1	ADESPIM	\N
public.users	-1	ADESPIM	\N
public.employees	-1	ADESPIM	\N
public.orderdetails	-1	ADESPIM	\N
public.orders	-1	ADESPIM	\N
public.products	-1	ADESPIM	\N
public.shippers	-1	ADESPIM	\N
public.suppliers	-1	ADESPIM	\N
public.customers	-1	ADESPIM	\N
admin_rights	-1	ADESPIM	\N
admin_members	-1	ADESPIM	\N
admin_users	-1	ADESPIM	\N
public.customers	1	S	
public.employees	1	SPI	
public.orders	1	AEDSPI	
public.shippers	1	S	
public.orderdetails	1	SPI	
public.products	1	SPI	
public.suppliers	1	SPI	
public.categories	1	SPI	
\.
...
5	Buchanan	Steven	1955-03-04 00:00:00	[{"name":"files\\/Young_neil_ep3wniyt.webp","usrName":"Young_neil.webp","size":77260,"type":"image\\/webp","thumbnail":"files\\/thYoung_neil_3d3kz7o0.webp","thumbnail_type":"image\\/webp","thumbnail_size":18644,"searchStr":"Young_neil.webp,!:sStrEnd"}]	Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London, where he was promoted to sales manager. Mr. Buchanan has completed the courses 'Successful Telemarketing' and 'International Sales Management'. He is fluent in French.
1	Davolio	Nancy	1968-12-08 00:00:00	[{"name":"files\\/Kim_Pine_h1rmsf1j.webp","usrName":"Kim_Pine.webp","size":72800,"type":"image\\/webp","thumbnail":"files\\/thKim_Pine_ownr1knz.webp","thumbnail_type":"image\\/webp","thumbnail_size":19810,"searchStr":"Kim_Pine.webp,!:sStrEnd"}]	Education includes a BA in psychology from Colorado State University. She also completed (The Art of the Cold Call). Nancy is a member of 'Toastmasters International'.
6	Suyama	Michael	1963-07-02 00:00:00	[{"name":"files\\/Wallace_Wells_hfa2rcye.webp","usrName":"Wallace_Wells.webp","size":69892,"type":"image\\/webp","thumbnail":"files\\/thWallace_Wells_0p58q72n.webp","thumbnail_type":"image\\/webp","thumbnail_size":17712,"searchStr":"Wallace_Wells.webp,!:sStrEnd"}]	Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing). He has also taken the courses 'Multi-Cultural Selling' and 'Time Management for the Sales Professional'. He is fluent in Japanese and can read and write French, Portuguese, and Spanish.
2	Fuller	Andrew	1952-02-19 00:00:00	[{"name":"files\\/Stephen_stills_jcd8wzgs.webp","usrName":"Stephen_stills.webp","size":89476,"type":"image\\/webp","thumbnail":"files\\/thStephen_stills_xaq0w8cd.webp","thumbnail_type":"image\\/webp","thumbnail_size":22524,"searchStr":"Stephen_stills.webp,!:sStrEnd"}]	Andrew received his BTS commercial and a Ph.D. in international marketing from the University of Dallas. He is fluent in French and Italian and reads German. He joined the company as a sales representative, was promoted to sales manager and was then named vice president of sales. Andrew is a member of the Sales Management Roundtable, the Seattle Chamber of Commerce, and the Pacific Rim Importers Association.
3	Leverling	Janet	1963-08-30 00:00:00	[{"name":"files\\/Envy-adams_hey9tn7q.webp","usrName":"Envy-adams.webp","size":58686,"type":"image\\/webp","thumbnail":"files\\/thEnvy-adams_ee57s6rr.webp","thumbnail_type":"image\\/webp","thumbnail_size":19352,"searchStr":"Envy-adams.webp,!:sStrEnd"}]	Janet has a BS degree in chemistry from Boston College). She has also completed a certificate program in food retailing management. Janet was hired as a sales associate and was promoted to sales representative.
7	King	Robert	1960-05-29 00:00:00	[{"name":"files\\/scott__0tdpip4m.jpg","usrName":"scott_.jpg","size":59064,"type":"image\\/jpeg","searchStr":"scott_.jpg,!:sStrEnd"}]	Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan and then joining the company. After completing a course entitled 'Selling in Europe', he was transferred to the London office.
8	Callahan	Laura	1958-01-09 00:00:00	[{"name":"files\\/Ramona_Flowers_naxwx1t6.webp","usrName":"Ramona_Flowers.webp","size":108100,"type":"image\\/webp","thumbnail":"files\\/thRamona_Flowers_8h7n4mvd.webp","thumbnail_type":"image\\/webp","thumbnail_size":20228,"searchStr":"Ramona_Flowers.webp,!:sStrEnd"}]	Laura received a BA in psychology from the University of Washington. She has also completed a course in business French. She reads and writes French.
4	Peacock	Margaret	1958-09-19 00:00:00	[{"name":"files\\/lisa_miller_7ayb49d8.jpg","usrName":"lisa_miller.jpg","size":144422,"type":"image\\/jpeg","thumbnail":"files\\/thlisa_miller_4bfjxqa6.jpg","thumbnail_type":"image\\/jpeg","thumbnail_size":47834,"searchStr":"lisa_miller.jpg,!:sStrEnd"}]	Margaret holds a BA in English literature from Concordia College and an MA from the American Institute of Culinary Arts. She was temporarily assigned to the London office before returning to her permanent post in Seattle.
9	Dodsworth	Anne	1969-07-02 00:00:00	[{"name":"files\\/knives_etbpz16e.jpg","usrName":"knives.jpg","size":50016,"type":"image\\/jpeg","searchStr":"knives.jpg,!:sStrEnd"}]	Anne has a BA degree in English from St. Lawrence College. She is fluent in French and German.
10	West	Adam	1928-09-19 00:00:00	[{"name":"files\\/todd_q8phbwo7.png","usrName":"todd.png","size":455183,"type":"image\\/png","thumbnail":"files\\/thtodd_awbwrhgu.png","thumbnail_type":"image\\/png","thumbnail_size":137678,"searchStr":"todd.png,!:sStrEnd"}]	An old chum.
11	Diaz	Kevin	2002-12-20 00:00:00	[{"name":"files\\/yop_5p8864h7.jpg","usrName":"yop.jpg","size":23078,"type":"image\\/jpeg","thumbnail":"files\\/thyop_rlrq2xe6.jpg","thumbnail_type":"image\\/jpeg","thumbnail_size":13453,"searchStr":"yop.jpg,!:sStrEnd"}]	Kevin is an intern at IUJO Barquisimeto.
\.
...
COPY public.products (productid, productname, supplierid, categoryid, unit, price, status, photo) FROM stdin;
21	Sir Rodney's Scones	8	3	24 pkgs. x 4 pieces	10	active	\N
22	Gustaf's Knäckebröd	9	5	24 - 500 g pkgs.	21	active	\N
23	Tunnbröd	9	5	12 - 250 g pkgs.	9	active	\N
24	Guaraná Fantástica	10	1	12 - 355 ml cans	4.5	active	\N
25	NuNuCa Nuß-Nougat-Creme	11	3	20 - 450 g glasses	14	active	\N
26	Gumbär Gummibärchen	11	3	100 - 250 g bags	31.23	active	\N
27	Schoggi Schokolade	11	3	100 - 100 g pieces	43.9	active	\N
28	Rössle Sauerkraut	12	7	25 - 825 g cans	45.6	active	\N
29	Thüringer Rostbratwurst	12	6	50 bags x 30 sausgs.	123.79	active	\N
30	Nord-Ost Matjeshering	13	8	10 - 200 g glasses	25.89	active	\N
31	Gorgonzola Telino	14	4	12 - 100 g pkgs	12.5	active	\N
32	Mascarpone Fabioli	14	4	24 - 200 g pkgs.	32	active	\N
33	Geitost	15	4	500 g	2.5	active	\N
34	Sasquatch Ale	16	1	24 - 12 oz bottles	14	active	\N
35	Steeleye Stout	16	1	24 - 12 oz bottles	18	active	\N
36	Inlagd Sill	17	8	24 - 250 g jars	19	active	\N
37	Gravad lax	17	8	12 - 500 g pkgs.	26	active	\N
38	Côte de Blaye	18	1	12 - 75 cl bottles	263.5	active	\N
39	Chartreuse verte	18	1	750 cc per bottle	18	active	\N
40	Boston Crab Meat	19	8	24 - 4 oz tins	18.4	active	\N
41	Jack's New England Clam Chowder	19	8	12 - 12 oz cans	9.65	active	\N
42	Singaporean Hokkien Fried Mee	20	5	32 - 1 kg pkgs.	14	active	\N
43	Ipoh Coffee	20	1	16 - 500 g tins	46	active	\N
44	Gula Malacca	20	2	20 - 2 kg bags	19.45	active	\N
45	Røgede sild	21	8	1k pkg.	9.5	active	\N
46	Spegesild	21	8	4 - 450 g glasses	12	active	\N
47	Zaanse koeken	22	3	10 - 4 oz boxes	9.5	active	\N
48	Chocolade	22	3	10 pkgs.	12.75	active	\N
49	Maxilaku	23	3	24 - 50 g pkgs.	20	active	\N
52	Filo Mix	24	5	16 - 2 kg boxes	7	active	\N
50	Valkoinen suklaa	23	3	12 - 100 g bars	16.25	active	\N
51	Manjimup Dried Apples	24	7	50 - 300 g pkgs.	53	active	\N
53	Perth Pasties	24	6	48 pieces	32.8	active	\N
54	Tourtière	25	6	16 pies	7.45	active	\N
55	Pâté chinois	25	6	24 boxes x 2 pies	24	active	\N
56	Gnocchi di nonna Alice	26	5	24 - 250 g pkgs.	38	active	\N
57	Ravioli Angelo	26	5	24 - 250 g pkgs.	19.5	active	\N
58	Escargots de Bourgogne	27	8	24 pieces	13.25	active	\N
59	Raclette Courdavault	28	4	5 kg pkg.	55	active	\N
60	Camembert Pierrot	28	4	15 - 300 g rounds	34	active	\N
61	Sirop d'érable	29	2	24 - 500 ml bottles	28.5	active	\N
62	Tarte au sucre	29	3	48 pies	49.3	active	\N
63	Vegie-spread	7	2	15 - 625 g jars	43.9	active	\N
64	Wimmers gute Semmelknödel	12	5	20 bags x 4 pieces	33.25	active	\N
65	Louisiana Fiery Hot Pepper Sauce	2	2	32 - 8 oz bottles	21.05	active	\N
66	Louisiana Hot Spiced Okra	2	2	24 - 8 oz jars	17	active	\N
67	Laughing Lumberjack Lager	16	1	24 - 12 oz bottles	14	active	\N
68	Scottish Longbreads	8	3	10 boxes x 8 pieces	12.5	active	\N
69	Gudbrandsdalsost	15	4	10 kg pkg.	36	active	\N
70	Outback Lager	7	1	24 - 355 ml bottles	15	active	\N
71	Fløtemysost	15	4	10 - 500 g pkgs.	21.5	active	\N
72	Mozzarella di Giovanni	14	4	24 - 200 g pkgs.	34.8	active	\N
73	Röd Kaviar	17	8	24 - 150 g jars	15	active	\N
74	Longlife Tofu	4	7	5 kg pkg.	10	active	\N
75	Rhönbräu Klosterbier	12	1	24 - 0.5 l bottles	7.75	active	\N
76	Lakkalikööri	23	1	500 ml	18	active	\N
77	Original Frankfurter grüne Soße	12	2	12 boxes	13	active	\N
1	Chais	1	1	10 boxes x 20 bags	18	inactive	[{"name":"files\\/chai-dirty-bio-la-boite-a-grains_6ahzxzaa.jpg","usrName":"chai-dirty-bio-la-boite-a-grains.jpg","size":49010,"type":"image\\/jpeg","searchStr":"chai-dirty-bio-la-boite-a-grains.jpg,!:sStrEnd"}]
2	Chang	1	1	24 - 12 oz bottles	19	active	[{"name":"files\\/0_0_orig_onnlpmyk.jpg","usrName":"0_0_orig.jpg","size":296950,"type":"image\\/jpeg","searchStr":"0_0_orig.jpg,!:sStrEnd"}]
4	Chef Anton's Cajun Seasoning	2	2	48 - 6 oz jars	22	active	[{"name":"files\\/product-00041351517267_1lqsajm5.png","usrName":"product-00041351517267.png","size":169213,"type":"image\\/png","searchStr":"product-00041351517267.png,!:sStrEnd"}]
3	Aniseed Syrup	1	2	12 - 550 ml bottles	10	active	[{"name":"files\\/619aUXdp+3L (1)_t68kcy2u.jpg","usrName":"619aUXdp+3L (1).jpg","size":80686,"type":"image\\/jpeg","searchStr":"619aUXdp+3L (1).jpg,!:sStrEnd"}]
5	Chef Anton's Gumbo Mix	2	2	36 boxes	21.35	active	[{"name":"files\\/001881366-1_lmjtb4a8.jpg","usrName":"001881366-1.jpg","size":54466,"type":"image\\/jpeg","searchStr":"001881366-1.jpg,!:sStrEnd"}]
9	Mishi Kobe Niku	4	6	18 - 500 g pkgs.	97	active	[{"name":"files\\/DSC_5529_filtered-L_xkdrlr8j.jpg","usrName":"DSC_5529_filtered-L.jpg","size":105393,"type":"image\\/jpeg","searchStr":"DSC_5529_filtered-L.jpg,!:sStrEnd"}]
10	Ikura	4	8	12 - 200 ml jars	31	active	[{"name":"files\\/mqvulizr2h46knkvr0e31p6wkhy95mn0_v281zdyi.jpg","usrName":"mqvulizr2h46knkvr0e31p6wkhy95mn0.jpg","size":37664,"type":"image\\/jpeg","searchStr":"mqvulizr2h46knkvr0e31p6wkhy95mn0.jpg,!:sStrEnd"}]
13	Konbu	6	8	2 kg box	6	active	[{"name":"files\\/71AmE6sC7CL_wlcdtebk.jpg","usrName":"71AmE6sC7CL.jpg","size":179380,"type":"image\\/jpeg","searchStr":"71AmE6sC7CL.jpg,!:sStrEnd"}]
17	Alice Mutton	7	6	20 - 1 kg tins	39	active	[{"name":"files\\/75489936_3mt54drx.jpg","usrName":"75489936.jpg","size":69866,"type":"image\\/jpeg","searchStr":"75489936.jpg,!:sStrEnd"}]
20	Sir Rodney's Marmalade	8	3	30 gift boxes	81	active	[{"name":"files\\/71-Dtp6PAKL_ll0wcitt.jpg","usrName":"71-Dtp6PAKL.jpg","size":241410,"type":"image\\/jpeg","searchStr":"71-Dtp6PAKL.jpg,!:sStrEnd"}]
6	Grandma's Boysenberry Spread	3	2	12 - 8 oz jars	25	active	[{"name":"files\\/resize_yf5y6lu1.jpg","usrName":"resize.jpg","size":51274,"type":"image\\/jpeg","searchStr":"resize.jpg,!:sStrEnd"}]
7	Uncle Bob's Organic Dried Pears	3	7	12 - 1 lb pkgs.	30	active	[{"name":"files\\/sung_kho_huu_co_sunny_fruit_250g-431x431_bafi9r1a.jpeg","usrName":"sung_kho_huu_co_sunny_fruit_250g-431x431.jpeg","size":32646,"type":"image\\/jpeg","searchStr":"sung_kho_huu_co_sunny_fruit_250g-431x431.jpeg,!:sStrEnd"}]
8	Northwoods Cranberry Sauce	3	2	12 - 12 oz jars	40	active	[{"name":"files\\/tarro-de-salsa-de-arandano-ocean-spray-aislado-en-blanco-con-sombra-suave-cpdcca_fgv1insn.jpg","usrName":"tarro-de-salsa-de-arandano-ocean-spray-aislado-en-blanco-con-sombra-suave-cpdcca.jpg","size":200614,"type":"image\\/jpeg","searchStr":"tarro-de-salsa-de-arandano-ocean-spray-aislado-en-blanco-con-sombra-suave-cpdcca.jpg,!:sStrEnd"}]
11	Queso Cabrales	5	4	1 kg pkg.	21	active	[{"name":"files\\/comprar-queso-cabrales-asturiano_v5h62ywd.jpg","usrName":"comprar-queso-cabrales-asturiano.jpg","size":763410,"type":"image\\/jpeg","searchStr":"comprar-queso-cabrales-asturiano.jpg,!:sStrEnd"}]
12	Queso Manchego La Pastora	5	4	10 - 500 g pkgs.	38	active	[{"name":"files\\/manchego-media_6xi1uyc8.jpg","usrName":"manchego-media.jpg","size":68214,"type":"image\\/jpeg","searchStr":"manchego-media.jpg,!:sStrEnd"}]
19	Teatime Chocolate Biscuits	8	3	10 boxes x 12 pieces	9.2	active	[{"name":"files\\/Tea-Time-Chocolate-40g-10-pack-WIBISCO-Web-Images-34_1h6wro9i.png","usrName":"Tea-Time-Chocolate-40g-10-pack-WIBISCO-Web-Images-34.png","size":499313,"type":"image\\/png","searchStr":"Tea-Time-Chocolate-40g-10-pack-WIBISCO-Web-Images-34.png,!:sStrEnd"}]
14	Tofu	6	7	40 - 100 g pkgs.	23.25	active	[{"name":"files\\/00008569660804L_juafivn2.jpg","usrName":"00008569660804L.jpg","size":185836,"type":"image\\/jpeg","searchStr":"00008569660804L.jpg,!:sStrEnd"}]
15	Genen Shouyu	6	2	24 - 250 ml bottles	15.5	active	[{"name":"files\\/yamasa-jian-yan-shiyouyu-yamasa-genen-shoyu-japanese-less-salt-soy-sauce-1l-340660_700x700_ez3anua4.jpg","usrName":"yamasa-jian-yan-shiyouyu-yamasa-genen-shoyu-japanese-less-salt-soy-sauce-1l-340660_700x700.jpg","size":27486,"type":"image\\/jpeg","searchStr":"yamasa-jian-yan-shiyouyu-yamasa-genen-shoyu-japanese-less-salt-soy-sauce-1l-340660_700x700.jpg,!:sStrEnd"}]
16	Pavlova	7	3	32 - 500 g boxes	17.45	active	[{"name":"files\\/receta-pavlova-decorada-frambuesas-frescas_3faiajh4.jpg","usrName":"receta-pavlova-decorada-frambuesas-frescas.jpg","size":47184,"type":"image\\/jpeg","searchStr":"receta-pavlova-decorada-frambuesas-frescas.jpg,!:sStrEnd"}]
18	Carnarvon Tigers	7	8	16 kg pkg.	62.5	active	[{"name":"files\\/tiger-char-kuay-teow_izc5fz4g.jpg","usrName":"tiger-char-kuay-teow.jpg","size":56049,"type":"image\\/jpeg","searchStr":"tiger-char-kuay-teow.jpg,!:sStrEnd"}]
\.
...
COPY public.users (userid, username, userpassword, usertype, productid) FROM stdin;
...
--
-- Name: Northwinduggroups_GroupID_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."Northwinduggroups_GroupID_seq"', 1, true);
...
--
-- Name: Northwinduggroups Northwinduggroups_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Northwinduggroups"
    ADD CONSTRAINT "Northwinduggroups_pkey" PRIMARY KEY ("GroupID");


--
-- Name: Northwindugmembers Northwindugmembers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Northwindugmembers"
    ADD CONSTRAINT "Northwindugmembers_pkey" PRIMARY KEY ("UserName", "GroupID", "Provider");


--
-- Name: Northwindugrights Northwindugrights_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Northwindugrights"
    ADD CONSTRAINT "Northwindugrights_pkey" PRIMARY KEY ("TableName", "GroupID");
